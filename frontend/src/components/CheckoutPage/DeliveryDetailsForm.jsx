    ...
    return (
        <>
            <div className="deliveryDetailsMain borderRadTopDiv">
                ...
                <DetailsEdit name="address" icon={<FaMapMarkerAlt className="icon" />} bold={address} sub={`${city}, ${state}`} button={{ text: "Edit" }} clicker={() => alert('Feature coming soon!')}/>
                <div className="slightBreak"></div>
                <DetailsEdit name="instructions" icon={<FaUser className="icon" />} bold={"Meet me at my door"} sub={`Add delivery instructions`} button={{ text: "Edit" }} clicker={() => alert('Feature coming soon!')}/>
            </div>
            ...
            <div className="deliveryDetailsMain">
                ...
                <DetailsEdit name="card" icon={<FaCreditCard className="icon" />} bold={"Credit Card"} sub={`${order?.user?.cardOnFile || "+ Visa ••••1234"}`} button={{ text: "Edit" }} clicker={() => alert('Feature coming soon!')}/>
                <div className="slightBreak"></div>
                <DetailsEdit name="instructions" icon={<FaTag className="icon" />} bold={"Add promo code"} button={{ text: "Add" }}  clicker={() => alert('Feature coming soon!')}/>
            </div>
            <div className="breaker"></div>
            <OrderSummary items={items} restaurantName={order.restaurant.name}/>
        </>
